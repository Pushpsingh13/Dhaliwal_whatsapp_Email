...
with c2:
    ...
    st.markdown(
        ...
        "Pickup Only • Freshly Prepared Orders required time as per order item. For Review Please Click Here https://g.page/r/CUkluFmztWfYEBM/review</p>",
        unsafe_allow_html=True
    )
    st.markdown(
        """
...
with c3:
    st.image(Review QR_PATH, width=90)
