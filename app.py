...
with st.container():
    ...
    with col2:
        ...
        st.write("Opening Hours: 10:00 AM – 10:00 PM Download our app for quick and easy ordering. Pickup only. Order preparation time depends on the items selected.")
                  # --- DOWNLOAD APP BUTTON ---
        st.markdown(
            """
