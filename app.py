...
with st.container():
    ...
    with col2:
        ...
        st.write("Dhaliwal’s Food Court Operating Hours: 10:00 AM – 10:00 PM Click the button below to download the app and place your next order. Pickup only (as per order).")
                  # --- DOWNLOAD APP BUTTON ---
        st.markdown(
            """
