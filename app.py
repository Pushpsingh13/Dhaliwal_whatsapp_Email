...
st.info("🛍️ Order Type: Pickup Only | No Delivery Available.***For Google Review Please Click on this link***  **https://g.page/r/CUkluFmztWfYEBM/review ** ***For Review on Google Scan The QR Code below.***")
