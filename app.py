...
st.info("🛍️ Order Type: Pickup Only | No Delivery Available.'For Review or Please Click on this link' 'https://g.page/r/CUkluFmztWfYEBM/review' 'For Review on Google Scan The QR Code below.'")
